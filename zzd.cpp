...
{
#ifndef HOMERUN
  const char *inName = "substr.in";
  const char *outName = "substr.out";
#else
...
void calcBranches(Node* curr)
{
  substrNum += curr->right - curr->left;
